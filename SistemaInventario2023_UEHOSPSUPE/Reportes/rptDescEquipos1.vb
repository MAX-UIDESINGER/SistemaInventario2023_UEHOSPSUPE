...
Public Class rptDescEquipos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaInventario2023_UEHOSPSUPE.rptDescEquipos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDescEquipos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDescEquipos = New rptDescEquipos()
        rpt.Site = Me.Site
        Return rpt
    End Function
