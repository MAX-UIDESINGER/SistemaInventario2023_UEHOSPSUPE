...
Public Class ContenidoDeshabilitado
    '-----------------------------------'
    ...
    Private Sub cargarRegistros()
        ...
        oDv = oTipoEquipoBL.EquipDeshabilitado().DefaultView
        dgvListaEquidDeshabitado.DataSource = oDv
    End Sub
    ...
    Private Sub ContadorDatos()
        Dim contador As DataRow = oTipoEquipoBL.ContadorDeshabilitado().Rows(0)
    ...
    Private Sub editarRegistroEquipo()
        If dgvListaEquidDeshabitado.Rows.Count = 0 Then
        ...
        Else
            ...
            oFrm.nuevo = False
            pId = dgvListaEquidDeshabitado.Rows(dgvListaEquidDeshabitado.CurrentRow.Index).Cells(0).Value
    ...
    Sub realizarBusquedadEquipo()
        ...
        End Select
    End Sub
    Private Sub ContenidoDeshabilitado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cargarRegistros()
        ContadorDatos()
        'obsion del combobox
        cargarComboSelected()
    ...
    Private Sub btnReporte_Click(sender As Object, e As EventArgs) Handles btnReporte.Click
        ...
        oFrm1.lbTitulo.Text = "Reporte Equipos Deshabilitados"
        nReporte = 3
